            ...
            { int hypre__i1start = (((cstart[0]) - ((((Ac_dbox) -> imin)[0]))) + (((cstart[1]) - ((((Ac_dbox) -> imin)[1]))) + (((cstart[2]) - ((((Ac_dbox) -> imin)[2]))) * (((0)<((((((Ac_dbox) -> imax)[1])) - ((((Ac_dbox) -> imin)[1])) + 1))) ? ((((((Ac_dbox) -> imax)[1])) - ((((Ac_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1))) ? ((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1)) : (0))); int hypre__sx1 = ((stridec[0]));int hypre__sy1 = ((stridec[1])*(((0)<((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1))) ? ((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1)) : (0)));int hypre__sz1 = ((stridec[2])* (((0)<((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1))) ? ((((((Ac_dbox) -> imax)[0])) - ((((Ac_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((Ac_dbox) -> imax)[1])) - ((((Ac_dbox) -> imin)[1])) + 1))) ? ((((((Ac_dbox) -> imax)[1])) - ((((Ac_dbox) -> imin)[1])) + 1)) : (0))); int hypre__nx = (loop_size[0]);int hypre__ny = (loop_size[1]);int hypre__nz = (loop_size[2]);int hypre__mx = hypre__nx;int hypre__my = hypre__ny;int hypre__mz = hypre__nz;int hypre__dir, hypre__max;int hypre__div, hypre__mod;int hypre__block, hypre__num_blocks;hypre__dir = 0;hypre__max = hypre__nx;if (hypre__ny > hypre__max){ hypre__dir = 1; hypre__max = hypre__ny;}if (hypre__nz > hypre__max){ hypre__dir = 2; hypre__max = hypre__nz;}hypre__num_blocks = 1;if (hypre__max < hypre__num_blocks){ hypre__num_blocks = hypre__max;}if (hypre__num_blocks > 0){ hypre__div = hypre__max / hypre__num_blocks; hypre__mod = hypre__max % hypre__num_blocks;};;
                for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) {
                    ...
                    if (hypre__num_blocks > 1){
                        if (hypre__dir == 0) {
                            loopi = hypre__block * hypre__div + (((hypre__mod)<(hypre__block)) ? (hypre__mod) : (hypre__block)); hypre__nx = hypre__div + ((hypre__mod > hypre__block) ? 1 : 0);
                    ...
                    iAc = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1;
                    for (loopk = 0; loopk < hypre__nz; loopk++) {
                        for (loopj = 0; loopj < hypre__ny; loopj++) {
                            ...
                            iAc += hypre__sy1 - hypre__nx*hypre__sx1;
                        }
                        iAc += hypre__sz1 - hypre__ny*hypre__sy1;
                    }
                }
            };
         }
               ...
               for (j = 0; j < ((compute_box_a) -> size); j++)
                  {
                     ...
                     {
                         int hypre__i1start = (((start[0]) - ((((A_dbox) -> imin)[0]))) + (((start[1]) - ((((A_dbox) -> imin)[1]))) + (((start[2]) - ((((A_dbox) -> imin)[2]))) * (((0)<((((((A_dbox) -> imax)[1])) - ((((A_dbox) -> imin)[1])) + 1))) ? ((((((A_dbox) -> imax)[1])) - ((((A_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1))) ? ((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__i2start = (((start[0]) - ((((x_dbox) -> imin)[0]))) + (((start[1]) - ((((x_dbox) -> imin)[1]))) + (((start[2]) - ((((x_dbox) -> imin)[2]))) * (((0)<((((((x_dbox) -> imax)[1])) - ((((x_dbox) -> imin)[1])) + 1))) ? ((((((x_dbox) -> imax)[1])) - ((((x_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1))) ? ((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__i3start = (((startc[0]) - ((((xc_dbox) -> imin)[0]))) + (((startc[1]) - ((((xc_dbox) -> imin)[1]))) + (((startc[2]) - ((((xc_dbox) -> imin)[2]))) * (((0)<((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1))) ? ((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1)) : (0)))) * (((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__sx1 = ((stride[0]));
                         int hypre__sy1 = ((stride[1])*(((0)<((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1))) ? ((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__sz1 = ((stride[2])* (((0)<((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1))) ? ((((((A_dbox) -> imax)[0])) - ((((A_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((A_dbox) -> imax)[1])) - ((((A_dbox) -> imin)[1])) + 1))) ? ((((((A_dbox) -> imax)[1])) - ((((A_dbox) -> imin)[1])) + 1)) : (0)));
                         int hypre__sx2 = ((stride[0]));
                         int hypre__sy2 = ((stride[1])*(((0)<((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1))) ? ((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__sz2 = ((stride[2])* (((0)<((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1))) ? ((((((x_dbox) -> imax)[0])) - ((((x_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((x_dbox) -> imax)[1])) - ((((x_dbox) -> imin)[1])) + 1))) ? ((((((x_dbox) -> imax)[1])) - ((((x_dbox) -> imin)[1])) + 1)) : (0)));
                         int hypre__sx3 = ((stridec[0]));
                         int hypre__sy3 = ((stridec[1])*(((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0)));
                         int hypre__sz3 = ((stridec[2])* (((0)<((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1))) ? ((((((xc_dbox) -> imax)[0])) - ((((xc_dbox) -> imin)[0])) + 1)) : (0))*(((0)<((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1))) ? ((((((xc_dbox) -> imax)[1])) - ((((xc_dbox) -> imin)[1])) + 1)) : (0)));
                         ...
                         if (hypre__ny > hypre__max){ hypre__dir = 1;
      ...
      for (ci = 0; ci < ((cgrid_boxes) -> size); ci++)
         {
            ...
            for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) {
                ...
                xi = hypre__i1start + loopi*hypre__sx1 + loopj*hypre__sy1 + loopk*hypre__sz1;
                xci = hypre__i2start + loopi*hypre__sx2 + loopj*hypre__sy2 + loopk*hypre__sz2;
                for (loopk = 0; loopk < hypre__nz; loopk++) {
                    for (loopj = 0; loopj < hypre__ny; loopj++) {
                        for (loopi = 0; loopi < hypre__nx; loopi++) {
                            {
                        ...
                        xi += hypre__sy1 - hypre__nx*hypre__sx1;
                        xci += hypre__sy2 - hypre__nx*hypre__sx2;
                    }
                    xi += hypre__sz1 - hypre__ny*hypre__sy1;
                    xci += hypre__sz2 - hypre__ny*hypre__sy2;
                }
            }
            };
         }
               ...
               for (j = 0; j < ((compute_box_a) -> size); j++)
                  {
                     ...
                     for (hypre__block = 0; hypre__block < hypre__num_blocks; hypre__block++) {
                         ...
                         // Ai,xi
                         //hypre__sx1,hypre__sx2
                         //hypre__sy1,hypre__sy2
                         //hypre__sz1,hypre__sz2

                         // doubles
                         // xp, Awp, xwp, xep, Aep, Ap

                         //outlined(&loopk, &loopi, &loopj,&hypre__nx, &hypre__ny, &hypre__nz,&Ai,&xi,&hypre__sx1,&hypre__sx2,&hypre__sy1,&hypre__sy2,
                         //         &hypre__sz1,&hypre__sz2,&xp, &Awp, &xwp, &xep, &Aep, &Ap);

                         //printf("%d %d %d \n",
                         //hypre__nx,hypre__ny,hypre__nz);
                         int trigger=(hypre__nz==50 && hypre__nx==50 && hypre__ny==50);
                         //double time_1;
                         //double time_2;
                         ...
                         printf("hypre__sx1: %d hypre__sx2: %d hypre__sy1: %d hypre__sy2: %d hypre__sz1: %d hypre__sz2:%d \n",
                                hypre__sx1,hypre__sx2,hypre__sy1,hypre__sy2,hypre__sz1,hypre__sz2);
                         ...
                         for (loopk = 0; loopk < hypre__nz; loopk++) {
                             for (loopj = 0; loopj < hypre__ny; loopj++) {
                                 for (loopi = 0; loopi < hypre__nx; loopi++) {
                                     ...
                                     if(loopi==(hypre__nx - 1)&&loopj==(hypre__ny - 1)){
                                         Ai += hypre__sz1 - hypre__ny*hypre__sy1;
                                         xi += hypre__sz2 - hypre__ny*hypre__sy2;
                                     }
                                     if(trigger)
                                         if(myid==0)
                                             if(loopj==(hypre__ny - 1) || loopj==0)
                                             printf("Ai: %d xi %d \n", Ai, xi);
                                 }
                                 //printf("loopi: %d \n", loopi);
