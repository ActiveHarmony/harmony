...
int get_code_completion_status(int simplex_size, int rank)
{
    ...
    if(rank == 0)
    {
        ...
        return_val = c_harmony_code_generation_complete();
...
int check_convergence(int simplex_size, int rank)
{
    ...
    if(rank == 0)
    {
        return_val = c_harmony_check_convergence();
...
int hypre_SMGResidual(void *residual_vdata,hypre_StructMatrix *A,hypre_StructVector *x,hypre_StructVector *b,hypre_StructVector *r)
{
    ...
    if(har_registration == 0)
    {
        ...
        TI=(int *)c_harmony_add_variable("smg2000","TI",1);
        TJ=(int *)c_harmony_add_variable("smg2000","TJ",1);
        TK=(int *)c_harmony_add_variable("smg2000","TK",1);
        UI=(int *)c_harmony_add_variable("smg2000","UI",1);
        US=(int *)c_harmony_add_variable("smg2000","US",1);
...
/* New static variables, precomputed */
    ...
    (stencil_size <= 15)?0 : ((__assert_fail(("stencil_size <= 15"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(203),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* # 236 "smg_residual.c" */
                            (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(357),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                            (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(358),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* Based on BG/L Milestone #46 */
                    (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(602),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                    (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(603),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                    (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(604),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                    ...
                    if (hypre__num_blocks == 1) {
                        ...
                        *(__out_argv1__1527__ + 20) = ((void *)(&A));
                        ...
                        int trigger = (stencil_size == 7) && (hypre__mz == 120) && (hypre__my == 120) && (hypre__mx==120);
//#ifdef USE_DLOPEN
                        if ( so_file_opened == 0 )
                        {  
                            ...
                            sprintf(filename,
                            "/hivehomes/tiwari/tutorial-2010/smg2000/test/OUT__1__6119__.chun.default.so");
#ifdef POSTHARMONY
                            FILE *tmp_f;
                            tmp_f=fopen("/hivehomes/tiwari/tutorial-2010/smg2000/test/lib/best_code_variant.txt", "r");
                            ...
                            OUT__1__6119__so = (OUT__1__6119__t)dlsym(FunctionLib, "OUT__1__6119__");
                            OUT__1__6119__best = (OUT__1__6119__t)dlsym(FLibBest, "OUT__1__6119__");
                            dlError = dlerror();
                            if( dlError )
                            {
                                printf("cannot find OUT__1__6119__() !\n");
                                exit(1);
                            }
                            so_file_opened = 1;
                        }
                        ...
                        if(trigger && !harmony_ended)
                        {
                            ...
                            if(default_performance_sent)
                            {
                                ...
                                if(myrank == 0)
                                {
                                    code_complete = c_code_generation_complete();
...
#ifdef _HOPPER_
                                    sprintf(filename,
                                    "/hivehomes/tiwari/scratch/tiwari/code/OUT__1__6119__%d_%d_%d_%d_%d.so",
                                    *TI, *TJ,*TK, *UI,*US);
#endif
                                    FunctionLib = dlopen(filename, RTLD_LAZY);
                                    dlError = dlerror();
                                    ...
                                    //MPI_Barrier(MPI_COMM_WORLD);
                                    time1__=time_stamp();
                                    OUT__1__6119__so(__out_argv1__1527__);
                                    time2__=time_stamp();
                                    ...
                                    MPI_Barrier(MPI_COMM_WORLD);
                                    // check if harmony is done
                                    harmony_ended=check_convergence(comm_size, myrank);
                                ...
                                } else
                                {
                                    ...
                                    time1__=time_stamp();
                                    OUT__1__6119__best(__out_argv1__1527__);
                                    time2__=time_stamp();
                                    perf_f=time2__-time1__;
                                    perf = perf_f * perf_multiplier;
                                    printf("Using the best for the trigger point: %d \n", perf);
                                }
                            } else
                            {
                        ...
                        } else
                        {
                            ...
                            //OUT__1__6119__ = (void (*) (void**)) dlsym(
                            // FLibBest, "OUT__1__6119__");
                            if(trigger)
                                printf("running with the best version.. search status done? %d \n", harmony_ended);
                            OUT__1__6119__best(__out_argv1__1527__);
                        }
#else
...
/* CORE LOOP BEGIN */
                                (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(689),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(690),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/tutorial-2010/smg2000/struct_ls/smg_residual.c"),(691),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                {
