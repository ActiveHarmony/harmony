...
/* Written and designed by: Ananta Tiwari
...
int main(int argc, char **argv) {
  ...
  /*
    ...
    test to see if the launched processes can also listen in the listen socket
  */
...
void generate_code(HDescrMessage *mesg, int client_socket) {
    ...
    int return_val=1;
    HDescrMessage *m = new HDescrMessage(HMESG_PROJ_RESULT,"1 2",return_val);
