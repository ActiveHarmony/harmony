...
static const char *print_type[] = {"NONE", "NODE_DESCR", "APP_DESCR", "DAEMON_REG", "CLIENT_REG", "VAR_DESCR", "VAR_REQ", "VAR_SET", "CLIENT_UNREG", "CONFIRMATION","FAILURE","PERFORMANCE_UPDT"};
