proc parallel_simplex_init {appName} {
    ...
    global ann_params
    #global ann_tree
    #global ann_data_file
    #global ann_tree_constructed
    
    # do projection?
    global do_projection
    
    # which projection? 1--> ANN 2--> Project dim by dim to the nearest boundary
    ...
    set simplex_low(value) 0
    set candidate_low(index) -1
    set candidate_low(value) 0
    ...
    set best_perf_so_far 1000000000000
    ...
    set ann_params(num_groups) 2
    set ann_params(group_info) {3 2}
    
    set initial_simplex_method 1
    
    # initial simplex params
    #  method 1 params
    set icsm_1_params(init_point) {100 10 20 4 4}
    set icsm_1_params(init_distance) {10 4}
    set icsm_1_params(num_neighbors) 1000
    
    # method 2 params
    set icsm_2_params(init_point) {-100 100}
    set icsm_2_params(scaling_vector) {20 20}
    ...
    # one configuration    64 100 40 40 8 8 100 20 is: 6413
    # 64 100 40 40 116 40 40 1 1 1 1 
