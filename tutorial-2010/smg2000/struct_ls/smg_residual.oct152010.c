...
int hypre_SMGResidual(void *residual_vdata,hypre_StructMatrix *A,hypre_StructVector *x,hypre_StructVector *b,hypre_StructVector *r)
{
    ...
    if(har_registration == 0)
    {
        ...
        harmony_application_setup_file(cmd);

        printf("Adding harmony variables ... \n");
        TI=(int *)harmony_add_variable("smg","TI",VAR_INT);
        TJ=(int *)harmony_add_variable("smg","TJ",VAR_INT);
        TK=(int *)harmony_add_variable("smg","TK",VAR_INT);
        UI=(int *)harmony_add_variable("smg","UI",VAR_INT);
        US=(int *)harmony_add_variable("smg","US",VAR_INT);
...
/* New static variables, precomputed */
    ...
    (stencil_size <= 15)?0 : ((__assert_fail(("stencil_size <= 15"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(203),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* # 236 "smg_residual.c" */
                            (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(357),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                            (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(358),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* Based on BG/L Milestone #46 */
                    (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(602),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                    (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(603),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                    (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(604),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
//#ifdef USE_DLOPEN
                        ...
                        {  
                            ...
                            sprintf(filename,
                            "/hivehomes/tiwari/backup_demo/smg2000/test/OUT__1__6119__.chun.default.so");
 


#ifdef POSTHARMONY
                            FILE *tmp_f;
                            tmp_f=fopen("/hivehomes/tiwari/backup_demo/smg2000/test/best_code_variant.txt", "r");
                        ...
                        if(trigger && !harmony_ended)
                        {
                            ...
                            if(default_performance_sent)
                            {
                                ...
                                if(myrank == 0)
                                {
                                    ...
                                    for(int proc_no = 1; proc_no < comm_size; proc_no++)
...
/* CORE LOOP BEGIN */
                                (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(689),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(690),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/backup_demo/smg2000/struct_ls/smg_residual.c"),(691),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                                {
