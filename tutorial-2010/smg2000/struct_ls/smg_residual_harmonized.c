...
//extern int hypre_SMGResidual(void *residual_vdata,hypre_StructMatrix *A,hypre_StructVector *x,hypre_StructVector *b,hypre_StructVector *r);
//extern void *hypre_SMGResidualCreate();
//extern int hypre_SMGResidualSetup(void *residual_vdata,hypre_StructMatrix *A,hypre_StructVector *x,hypre_StructVector *b,hypre_StructVector *r);
...
int hypre_SMGResidual(void *residual_vdata,hypre_StructMatrix *A,hypre_StructVector *x,hypre_StructVector *b,hypre_StructVector *r)
{
  ...
  if(har_registration == 0)
  {
      ...
      // set a barrier here?
      //hypre_MPI_Barrier(comm_handle);

      printf("Adding a harmony variable ....");
      TI=(int *)harmony_add_variable("smg2000","TI",VAR_INT);
      TJ=(int *)harmony_add_variable("smg2000","TJ",VAR_INT);
      harmony_performance_update(100000);
      har_registration++;
      harmony_request_all();
  }
#endif
/* New static variables, precomputed */
  ...
  (stencil_size <= 15)?0 : ((__assert_fail(("stencil_size <= 15"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(203),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* # 236 "smg_residual.c" */
              (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(357),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
              (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(358),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
/* Based on BG/L Milestone #46 */
          (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(602),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
          (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(603),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
          (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(604),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
...
//#######################################
                ...
                } else
                {
                    ...
                    if(code_complete == 1)
                    {
                        ...
                        FunctionLib = dlopen("./OUT__1__6119__.so",RTLD_LAZY);
                        dlError = dlerror();
                        if( dlError ) {
                ...
                FunctionLib = (void *)dlopen("./OUT__1__6119__.so",RTLD_LAZY);
                dlError = dlerror();
                if( dlError ) {
                    printf("cannot open .so file!\n");
                    exit(1);
...
/* CORE LOOP BEGIN */
                (hypre__sx1 == 1)?0 : ((__assert_fail(("hypre__sx1 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(689),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                (hypre__sx2 == 1)?0 : ((__assert_fail(("hypre__sx2 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(690),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
                (hypre__sx3 == 1)?0 : ((__assert_fail(("hypre__sx3 == 1"),("/hivehomes/tiwari/rose_smg2000/code_specialization/smg2000/struct_ls/smg_residual.c"),(691),("int hypre_SMGResidual(void *, struct hypre_StructMatrix_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *, struct hypre_StructVector_struct *)")) , 0));
{
