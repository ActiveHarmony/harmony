proc parallel_simplex_init {appName} {
    ...
    set ann_params(init_simplex_name) "/hivehomes/tiwari/tutorial-2010/harmony/bin/constructed_simplex.dat"
    ...
    set icsm_1_params(use_exploration_point) 1

    # method 2 params
    set icsm_2_params(init_point) {200 200 200 4 4}
    set icsm_2_params(scaling_vector) {80 30 80 2 4}
    ...
    set ndm_1_params(starting_distance) {4 1}
    set ndm_1_params(curr_distance) {10 1}
    set ndm_1_params(distance_step) {5 1}
    ...
    set ndm_4_params(distance_step) {4}

    puts "Using gemm init file ::"
