proc parallel_simplex_init {appName} {
    ...
    # method 2 parameters
    set code_generation_params(code_generation_destination) "rahulp@armour:/fs/armour/rahulp/scratch/confs/"
    ...
    set icsm_4_params(init_point) {30 30}
    ...
    set ndm_4_params(starting_distance) {4 4}
    set ndm_4_params(curr_distance) {1}
