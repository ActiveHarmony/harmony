...
proc obsGoodness {min max args} {
    ...
    # we are using parallel simplex now
    #simplex_init $appName

    # pro_init should make a call to pro to set the initial simplex.
...
proc updateObsGoodness {appName value timestamp args} {
    ...
    if {$isglobal==1} {
        ...
        if {$i == [llength $deplocals]} {
            ...
            #lappend coords $time [canvasyCoord $appName $current_low]
