...
#define CMESG_CODE_GENERATION_REQ 0
#define CMESG_CODE_COMPLETE_QUERY 1
#define CMESG_CODE_GENERATION_REQ_CONFIRM 2
#define CMESG_CODE_COMPLETE_RESPONSE 3
#define CMESG_CODE_REQ_RES 4
#define CMESG_CLIENT_REG 5
#define CMESG_CLIENT_UNREG 6
#define CMESG_CONFIRM 7
#define CMESG_FAIL 8
#define CMESG_NONE 9
/*
 ...
 * For now we only define it 6144 chars.
 * If the configurations start getting bigger, we can increase this value.
 */
#define VAR_STR_SIZE 6144
...
static const char *print_type[] = {"CODE_GENERATION_REQ",
                                   "CODE_COMPLETE_QUERY",
                                   "CODE_GENERATION_REQ_CONFIRM",
