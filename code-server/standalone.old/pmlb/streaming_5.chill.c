...
extern void streaming_5(double *, int, int, int, struct __tmp_struct1 *);

extern void streaming_5(double *fi, int nx_local, int ny_local, int nz_local, struct __tmp_struct1 *i_c)
  {
    int i;
    int j;
    int k;
                    ...
                    for (t10 = 1; t10 <= -over1 + kmax; t10 += 3)
                      {
                        ...
                        n_ijk = (n_ij + t10) * 19;
                        fi[8 + n_ijk] = fi[8 + (t10 + n_ip1jm1) * 19];
                        fi[17 + n_ijk] = fi[17 + (t10 + 1 + n_ijm1) * 19];
                        n_i = t6 * ny_local_plus;
                        n_ip1 = n_i + ny_local_plus;
                        j = jmax + 1 - t8;
                        n_ij = (n_i + j) * nz_local_plus;
                        ...
                        n_ijm1 = (n_i + j - 1) * nz_local_plus;
                        n_ijk = (n_ij + t10 + 1) * 19;
                        fi[8 + n_ijk] = fi[8 + (t10 + 1 + n_ip1jm1) * 19];
                        fi[17 + n_ijk] = fi[17 + (t10 + 1 + 1 + n_ijm1) * 19];
                        n_i = t6 * ny_local_plus;
                        n_ip1 = n_i + ny_local_plus;
                        j = jmax + 1 - t8;
                        n_ij = (n_i + j) * nz_local_plus;
                        ...
                        n_ijm1 = (n_i + j - 1) * nz_local_plus;
                        n_ijk = (n_ij + t10 + 2) * 19;
                        fi[8 + n_ijk] = fi[8 + (t10 + 2 + n_ip1jm1) * 19];
                        fi[17 + n_ijk] = fi[17 + (t10 + 2 + 1 + n_ijm1) * 19];
                      }
