...
if [ $useChill -eq 1 ]; then
    ...
    chill temp_1_3.script;
    s2c streaming_1_3.lxf streaming_1_3.chill.c;

    chill temp_2.script;
    s2c streaming_2.lxf streaming_2.chill.c;
    ...
    if [ $useICC -eq 1 ]; then
        ...
        #echo "using gcc"
        gcc  -fpic -c -o streaming_1_3.o streaming_1_3.chill.c -O3 -msse2
        ...
        gcc --shared -lc -o ../newcode/$out_file streaming_1_3.o streaming_2.o streaming_4.o streaming_5.o
